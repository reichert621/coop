      ...
      <main className="mx-auto flex w-full max-w-2xl flex-1 flex-col py-8">
        <div className="flex flex-1 flex-col px-4 py-8 sm:px-8 sm:py-16">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-lg text-gray-300">
              Here is a rough demo of how the functionality might look, with the
              webpage on the left, and the Discord channel window on the right.
            </p>
            ...
            <h2 className="mt-2 text-3xl font-bold text-white">Instructions</h2>
            ...
            <p className="text-lg text-gray-300">
              ...
              if you have some basic understanding of JavaScript and ReactJS, it
              shouldn&apos;t be too difficult to learn.)
            </p>

            <p className="text-lg text-gray-300">
              Once your app boilerplate is set up and running, you&apos;ll need
              to create a{' '}
              <a
                className="text-gray-100 underline hover:text-white"
            ...
            <p className="text-lg text-gray-300">
              You can use whatever libraries or resources you like to build your
              app, but it shouldn&apos;t require much. (For example, in my demo
              above, I used TailwindCSS for styling the UI, but for something so
              simple basic CSS would be totally fine.)
            </p>

            <p className="text-lg text-gray-300">
              In order to send messages to Discord, you&apos;ll need to use this
              API endpoint I set up. If you copy the cURL command below into
              your terminal, and replace <code>YOUR_ACCESS_TOKEN</code> with the
              token I provided in my email, you should be able to see how it
              works:
            </p>
            ...
            <p className="text-lg text-gray-300">
              Once your app is ready, you&apos;ll need to set up a free account
              with{' '}
              <a
                className="text-gray-100 underline hover:text-white"
            ...
            <p className="text-lg text-gray-300">
              When you&apos;re happy with your app, and it has been successfully
              deployed to Vercel, reply to my email with a link. The link should
              look something like <code>https://xxxxx.vercel.app</code>.
            </p>
            ...
            <p className="text-lg text-gray-300">
              ...
              you&apos;re verified, you&apos;ll be able to ask questions in the
              private homework{' '}
              <a
                className="text-gray-100 underline hover:text-white"
